...
def agent(state_shape, action_shape):
    ...
    model.add(keras.layers.Dense(1024, input_shape=state_shape, activation='relu', kernel_initializer=init))
    ...
    for episode in range(train_episodes):
        ...
        while not done:
            ...
            if random_number <= epsilon:
                ...
                old_action = action
            new_observation, reward, done, info = env.step(action, zero_list, step_per_episode)
